...
#Containers From Scratch • Liz Rice • GOTO 2018
  https://youtu.be/8fi7uSYlOdc?si=9k5TKBSOWkM-i1En 

-yeh make a Containers from scratch using #GoLang 
...
#You need root permissions for this version to work. Or you can adapt it to be a rootless container by as shown in these slides.
  https://speakerdeck.com/lizrice/rootless-containers-from-scratch 
